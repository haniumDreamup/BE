...
# 14. 잘못된 사용자 ID 형식
test_endpoint "GET" "/api/v1/users/invalid" "잘못된 사용자 ID 형식" "400"

# 15. 빈 JSON 데이터로 본인 정보 수정
test_endpoint "PUT" "/api/v1/users/me" "빈 JSON 데이터로 본인 정보 수정" "401" '{}'

# 16. 잘못된 JSON 형식 - 본인 정보 수정
...
# 18. 정렬 파라미터 테스트
test_endpoint "GET" "/api/v1/users?sort=createdAt,desc" "사용자 목록 조회 (정렬)" "401"
