...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleBifException(BifException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleEmergencyException(EmergencyException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleSafetyViolation(SafetyViolationException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleCognitiveOverload(CognitiveOverloadException ex) {
    ...
    public ResponseEntity<ApiResponse<Void>> handleDeviceConnection(DeviceConnectionException ex) {
