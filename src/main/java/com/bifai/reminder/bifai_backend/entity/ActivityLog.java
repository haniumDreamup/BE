...
@Table(name = "activity_logs", indexes = {
    @Index(name = "idx_activity_user_created", columnList = "user_id, createdAt"),
    @Index(name = "idx_activity_type_created", columnList = "activityType, createdAt"),
    @Index(name = "idx_activity_date_type", columnList = "activityDate, activityType"),
    @Index(name = "idx_activity_success_status", columnList = "successStatus, createdAt"),
    @Index(name = "idx_activity_device", columnList = "device_id, createdAt")
})
