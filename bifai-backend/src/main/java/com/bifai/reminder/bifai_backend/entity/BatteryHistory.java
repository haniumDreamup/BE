...
@Table(name = "battery_history",
       indexes = {
           @Index(name = "idx_battery_device_time", columnList = "device_device_id, recorded_at"),
           @Index(name = "idx_battery_level", columnList = "battery_level"),
           @Index(name = "idx_battery_charging", columnList = "is_charging")
       })
@Getter
